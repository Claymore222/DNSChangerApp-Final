...
namespace DNSChangerApp
{
    public partial class Form1 : Form
    {
        ...
        public Form1(bool autorun = false)
        {
            InitializeComponent();
            isAutorun = autorun;
        }
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                DosyaCikar("discord-blacklist.txt", Path.Combine(hedefKlasor, "discord-blacklist.txt"));
        ...
        private void chkBaslangic_CheckedChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (chkBaslangic.Checked)
                {
                    ...
                    string komut = $"schtasks /create /tn \"{gorevAdi}\" /tr \"\\\"{exePath}\\\" -autorun\" /sc onlogon /rl highest /f";
                    KomutCalistir(komut);
                }
                else
                {
        ...
        public void ServisBaslat()
        {
            ...
            string parametreler = $"-5 --set-ttl 5 --dns-addr 77.88.8.8 --dns-port 1253 --dnsv6-addr 2a02:6b8::feed:0ff --dnsv6-port 1253 --blacklist \"{hedefKlasor}\\discord-blacklist.txt\"";
